...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://127.0.0.1/games/duimutou/icon.png",
		url: "http://127.0.0.1/games/duimutou/",
		title: "堆木头，简单的不得了，好玩的停不下",
		desc: "玩法简单，但是玩的是技巧，反应，没有最高只有更高，来挑战下--关注H5小游戏:weixinhao"
	};
...
function updateShare(stscore) {
	imgUrl = 'http://127.0.0.1/games/duimutou/i/icon.png';
	lineLink = 'http://127.0.0.1/games/duimutou';
