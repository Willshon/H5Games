		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://127.0.0.1";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://127.0.0.1";
y.url = function() {
	return "http://127.0.0.1?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://127.0.0.1/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("H5小游戏—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("H5小游戏", "Arial", 12);
