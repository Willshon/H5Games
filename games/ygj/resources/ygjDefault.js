...
var rankurl = 'http://127.0.0.1/games/ygj/index.html';
window.shareData = {
    "imgUrl": "http://127.0.0.1/games/ygj/resources/logo_small.jpg",
    "timeLineLink": "http://127.0.0.1/games/ygj/index.html",
...
function clickMore(){
			if((window.location+"").indexOf("zf",1)>0){
				window.location = "http://127.0.0.1/games/ygj/index.html";
			 }
			 else{
				goHome();
			 }
